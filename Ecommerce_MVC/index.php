        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-4" style="background-color: #C0ECFF;">
                    <img src="view/imagem/logoMercadoAvaliacao.png" alt="" width="160">
                </div>
                <div class="col-4"  style="background-color: #C0ECFF;">
                </div>
                <div class="col-4"  style="background-color: #C0ECFF;">
...
<nav class="navbar navbar-expand-lg navbar-dark rounded" style="background-color: #7AB92D; max-width: 1140px">
  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="view/pg_latarias.php">Latarias</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="view/pg_salgadinhos.php">Salgadinhos</a>
      </li>
    </ul>
    ...
    ?>
      ...
      <div class="col-md-3">
        <div class="card" style="width: 18rem;">
          <img class="card-img-top" src="view/img/<?php echo $produto['imgpq']; ?>.png" alt="Card image cap">
          <div class="card-body">
            ...
            <!--<a href="view/pg_exibeprod.php" class="btn btn-primary">Ver produto</a>-->
            <form action="view/pg_exibeprod.php" method="post">
...
<script src="view/js/busca.js"></script>
